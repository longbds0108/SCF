...
/**
 * USDC token mark — CC0-licensed (public domain), sourced from the atomiclabs/cryptocurrency-icons
 * project rather than Circle's own trademarked brand assets, so it's safe to redistribute here.
 * https://github.com/atomiclabs/cryptocurrency-icons (CC0-1.0)
 */
